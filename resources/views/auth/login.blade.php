            ...
            <div class="row">
                ...
                <div class="col-md-5 d-flex flex-column justify-content-center">
                    ...
                    <div class="text-center">
                        <img src="{{ asset('images/young.svg') }}" alt="Forgot Password" class="forgot-password-image img-fluid">
                    </div>
                </div>
                ...
                <div class="col-md-7 d-flex flex-column justify-content-center">
                    <form id="loginForm" style="margin-top: 10rem;">
                        ...
                        <div class="d-flex justify-content-between mb-4">
                            ...
                            <div>
                                <a href="{{ url('/forgot-password') }}" class="text-secondary text-decoration-none">Forgot Password?</a>
                            </div>
                        </div>
