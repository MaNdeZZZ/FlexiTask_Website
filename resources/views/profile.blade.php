    ...
    <div class="container-fluid p-0">
        <div class="profile-container">
            ...
            <div class="profile-header d-flex align-items-center">
                <button class="btn p-0 me-3" onclick="window.location.href='dash2.html'">
...
<body>
    <div class="container-fluid p-0">
        <div class="profile-container">
            <!-- Header -->
            <div class="profile-header d-flex align-items-center">
                <button class="btn p-0 me-3" onclick="window.location.href='{{ url('/dashboard') }}'">
                    <i class="bi bi-arrow-left"></i>
                </button>
                <h5 class="mb-0 fw-bold">Profile</h5>
            </div>
            ...
            <div class="px-4 pb-4">
                ...
                <div class="text-center mb-4">
                    <div class="profile-picture-container">
                        <div id="profileImageContainer" class="profile-picture">
                            <img id="profileImage" src="{{ asset('images/logo.png') }}" alt="Profile Picture" class="profile-picture" style="display: none;">
                            <div id="defaultProfileImage" class="default-profile-container">
                                <span class="default-profile-initials">?</span>
                            </div>
                        </div>
